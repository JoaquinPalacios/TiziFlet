        ...
        <NavbarBootstrap className='my-0' collapseOnSelect expand="lg" expanded={expanded}>
            ...
            <NavbarBootstrap.Collapse className='col-4 col-lg-11 toggleBg' id="responsive-navbar-nav">
                ...
                <Nav.Item className='col-8 col-lg-6 col-xl-4 d-flex justify-content-end align-self-center me-2'>
                    <Link href="/" onClick={() => setExpanded(false)}><a className='mx-3 my-2 pt-3 pt-md-0 my-lg-0'>Inicio</a></Link>
                    <Link href="/about" onClick={() => setExpanded(false)}><a className='mx-3 my-2 my-lg-0'>Quienes Somos</a></Link>
                    <Link href="/contacto" onClick={() => setExpanded(false)}><a className='ms-3 me-xl-2 my-2 my-lg-0'>Contacto</a></Link>
                </Nav.Item>
