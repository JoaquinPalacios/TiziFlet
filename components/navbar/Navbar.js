    ...
    return ( 
        <NavbarBootstrap className='my-0' collapseOnSelect expand="lg" expanded={expanded}>
            ...
            <NavbarBootstrap.Collapse className='col-4 col-lg-11 toggleBg' id="responsive-navbar-nav">
                ...
                <Nav.Item className='col-8 col-lg-6 col-xl-4 flex-column flex-lg-row d-flex justify-content-end align-self-center me-2' onClick={() => setExpanded(false)}>
                    <Link href="/"><a className='mx-3 my-2 my-lg-0 pt-3 pt-lg-0'>Inicio</a></Link>
